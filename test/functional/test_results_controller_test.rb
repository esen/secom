...
class TestResultsControllerTest < ActionController::TestCase
  ...
  test "should create test_result" do
    assert_difference('TestResult.count') do
      post :create, test_result: { mark: @test_result.mark, student_id: @test_result.student_id, test_id: @test_result.test_id }
    end
  ...
  test "should update test_result" do
    put :update, id: @test_result, test_result: { mark: @test_result.mark, student_id: @test_result.student_id, test_id: @test_result.test_id }
    assert_redirected_to test_result_path(assigns(:test_result))
  end
